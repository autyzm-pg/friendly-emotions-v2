package pg.autyzm.graprzyjazneemocje.ustawienia.camera;
...
import pg.autyzm.graprzyjazneemocje.ustawienia.AddMaterial;
...
public class PictureActivity extends AppCompatActivity {
    ...
    public String saveImage(Bitmap myBitmap) {
        ...
        File wallpaperDirectory = new File(
                getExternalFilesDirs(null)[0] + IMAGE_DIRECTORY);
