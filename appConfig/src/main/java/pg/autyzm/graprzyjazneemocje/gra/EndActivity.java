...
//repeat a level
        ...
        mainMenuButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent launchIntent = new Intent(EndActivity.this, pg.autyzm.graprzyjazneemocje.ustawienia.SplashActivity.class);
    ...
    private void repeatLevel(View view) {
        ...
        Intent intent = new Intent(EndActivity.this, SplashActivity.class);
