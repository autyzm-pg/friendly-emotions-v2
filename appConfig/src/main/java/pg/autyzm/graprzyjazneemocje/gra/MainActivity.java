...
import pg.autyzm.graprzyjazneemocje.gra.animation.AnimationActivity;
import pg.autyzm.graprzyjazneemocje.gra.animation.AnimationEndActivity;
...
public class MainActivity extends Activity implements View.OnClickListener, ISounds {
    ...
    private int attempt;
    private boolean clickedSpeaker = false;
...
//                    speaker = Speaker.getInstance(MainActivity.this);
            ...
            new AlertDialog.Builder(MainActivity.this)
                    .setTitle(getResources().getString(R.string.noLevelFoundTitle))
                    .setMessage(getResources().getString(R.string.noLevelFoundMessage))
                    .setCancelable(false)
    ...
    boolean loadLevel(Level level) {
        ...
        Collections.shuffle(sublevelsList);
        generateSublevel(sublevelsList.get(sublevelsLeft - 1));
    ...
    void generateSublevel(int emotionIndexInList) {
        ...
        Collections.shuffle(photosToUseInSublevel);
    ...
    public void generateView(List<String> photosList) {
        ...
        if (!videos) {
            ...
            if (level.getQuestionType().equals(Level.Question.SHOW_WHERE_IS_EMOTION_NAME)) {
                ...
                commandWithoutEmotion = getResources().getString(R.string.show_game);
                emotion = rightEmotionLang;
                commandText = commandWithoutEmotion + " " + emotion;
                onlyEmotion = false;
...
//        }
    ...
    public void image_zoom(ImageView image, AnimationSet animationSet) {
        Animation zooming;
        ...
        animationSet.addAnimation(zooming);
...
//                                        image.startAnimation(shake);
                                        ...
                                        /*Animation zooming;
                                        zooming = AnimationUtils.loadAnimation(MainActivity.this, R.anim.zoom);
                                        zooming.scaleCurrentDuration(1.05f);
                                        image.hasOverlappingRendering();
                                        setLayoutMargins(image, 45 / listSize + 10, 45 / listSize + 10, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 790 / listSize, getResources().getDisplayMetrics()));
                                        //image.startAnimation(zooming);
                                        ...
                                        s.addAnimation(shake);
                                        s.addAnimation(zooming);
    ...
    public boolean complexSoundsToApply(String commandText, String emotion, boolean onlyEmotion) throws IOException {
